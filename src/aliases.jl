...
@objectnames PSU2_4 = PMFC{3, 1, 0, 2, 0, 1} 0 4 2 # Non-modular. {0, 4} form a Rep[Z₂] braided subcategory. Have the same fusion rule as Rep[D₃], but different braiding.
...
# How to understand PMFC{4, 1, 0, 3, 0, 1} and PMFC{4, 1, 0, 3, 0, 2}? They are non-modular, with the same fusion rule as Rep[D₅], with the Muger center Rep[Z₂]. What is its minimal modular extension?
